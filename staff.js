(() => {
  ...
  async function registerServiceWorker(){
    ...
    try{swRegistration=await navigator.serviceWorker.register('./sw.js?v=373');return swRegistration;}catch(e){console.warn('Service worker registration failed',e);return null;}
  }
